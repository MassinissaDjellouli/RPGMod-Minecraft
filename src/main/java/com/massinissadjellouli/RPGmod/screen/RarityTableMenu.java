...
public class RarityTableMenu extends AbstractContainerMenu {
    public final RarityTableBlockEntity blockEntity;
    private final Level level;

    public RarityTableMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.RARITY_TABLE.get());
    }
